...
<td className="px-3 py-4 text-center  text-sm text-black whitespace-nowrap">{loan.duration}yrs</td>
<td className="px-3 py-4 text-center font-bold text-sm whitespace-nowrap ">
  <a href={pdf} target="_blank" rel="noopener noreferrer" className="inline-flex px-2 text-xs font-semibold leading-5 text-indigo-800 bg-indigo-100 rounded-full">
    View
				...
				<td className="px-3 py-4 text-center font-bold text-sm text-black whitespace-nowrap">₹{MonthlyDue(loan.amount,loan.duration,(loan.interest/100))}</td>
                <td className="px-3 py-4 text-center font-bold text-sm text-black whitespace-nowrap">₹{loan.total}</td>
                
                <td className="px-3 flex gap-5 cursor-pointer py-4 text-center text-base whitespace-nowrap">
