...
import Edit from './profiledetails';
		...
		<div class="flex flex-col w-full  justify-center items-center ">
            <div class="relative h-[90vh] flex flex-col items-center   w-full mx-auto p-4 bg-white bg-clip-border shadow-3xl shadow-shadow-500  ">
                ...
                <div class="mt-6 mb-3 flex gap-14 md:!gap-14">
                    ...
                    <p class="text-2xl font-bold text-navy-700 ">{details.intrest}%</p>
                    <p class="text-sm font-normal text-gray-600">Rate Of Intrest</p>
                    </div>
                    <div class="flex flex-col items-center justify-center">
                    <p class="text-2xl font-bold text-navy-700 ">
                    {details.emailverified ? <FontAwesomeIcon icon="fas fa-circle-check" title='verified' className='text-green-600' /> : <FontAwesomeIcon icon='fas fa-circle-xmark' title='Not verified' className='text-red-600' />}
                    </p>
                    <p class="text-sm font-normal text-gray-600">Email Verified</p>
                    </div>
                    <div class="flex flex-col items-center justify-center">
                    <p class="text-2xl font-bold text-navy-700 ">
					{details.timeperiod} <span className='text-xl'>Months</span>
                    </p>
                    <p class="text-sm font-normal text-gray-600">Reschdule Period</p>
                    </div>
