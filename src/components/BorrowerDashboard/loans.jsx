...
function Loans() {
  ...
  return (
    <div className="flex flex-col  h-[90vh] overflow-scroll items-center w-full">
      ...
      <div className="flex lg:w-[95%] w-full lg:p-0 px-3 h-[90vh] flex-col">
        ...
        <td colSpan="10" className='text-center py-4'>No Active Loans</td>
              ...
              <tr key={loan.loanid} className="transition-all hover:bg-gray-100 hover:shadow-lg">
                ...
                <td className="px-3 py-4 text-center font-bold text-sm text-black whitespace-nowrap">₹{loan.pamount}</td>
                <td className="px-3 py-4 text-center text-sm  text-gray-500 whitespace-nowrap">( {loan.interest}% )yr</td>
                ...
                <td className="px-3 py-4 text-center font-bold text-sm text-black whitespace-nowrap">₹{MonthlyDue(loan.pamount,loan.timeperiod,(loan.interest/100))}</td>
                <td className="px-3 cursor-pointer py-4 text-sm whitespace-nowrap"> <button ><Payment details={loanDetails[index]} paymentamount={MonthlyDue(loan.pamount,loan.timeperiod,(loan.interest/100))} /></button></td>
              </tr>
            ))}
          </tbody>
        </table>
